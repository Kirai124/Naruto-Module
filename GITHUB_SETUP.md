# GitHub update instructions — 0.15.0

Repository: `https://github.com/Kirai124/Naruto-Module`

## Upload the new repository files

1. Extract `Naruto-Module-main-0.15.0.zip` on your computer.
...
4. Commit directly to `main`, for example with `Add Crimson Priest and damage automation v0.15.0`.
...
3. Choose **Create new tag** and enter `v0.15.0`.
...
- `module.json`
- `n5eb-classmod-library-0.15.0.zip`
- GitHub's automatic source-code archives

## Repair or rerun the release

Open **Actions → Build Foundry Release → Run workflow**, enter `v0.15.0`, and run it. The workflow recreates or replaces the Foundry release assets from the current `main` branch.
