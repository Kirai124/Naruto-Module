...
Tag the release as `v0.13.4` and attach `n5eb-classmod-library-0.13.4.zip`. This release adds the Normal / Elite / Solo tier picker and the redesigned dedicated Edo Tensei creators.
